...
class Microservice extends Component {
    ...
    componentDidMount() {
        ...
        if (params.serviceName === 'skiResort'){
            ...
            searchQuery = "state=" + params.state + "&city=" + params.city + '&museumName=' + params.museumName;
        }
            ...
            searchQuery = "state=" + params.state + "&founded="
                + params.founded + "&city=" + params.city;
        }
        ...
        axios.post('http://western01-gateway-pipeline.mybluemix.net/service/search', body, axiosConfig)
        .then((res) => {
            console.log("res = ", res);
